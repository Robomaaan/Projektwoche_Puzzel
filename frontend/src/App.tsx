...
function Play({ project, refresh, nav, setError }: any) {
  ...
  const trayX = 970, trayY = 96;
  const trayCols = 2;
  const trayGapX = Math.max(96, Math.min(160, pieceW * 0.64));
  const trayGapY = Math.max(86, Math.min(135, pieceH * 0.58));
